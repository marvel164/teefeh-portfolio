      ...
      <section className="bg-[#F7F6EC] py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            variants={fadeInUp}
            className="bg-[#FF1717] rounded-[36px] p-8 md:p-12 lg:p-12 mx-18 overflow-hidden"
          >
            {/* Header */}
            <div className="flex flex-col lg:items-center gap-8">
              ...
              >
                ...
                <motion.div
                  ...
                  className="w-15 h-15 rounded-2xl bg-white flex items-center justify-center shrink-0"
                >
                  <Brain size={38} className="text-[#FF1717]" />
                </motion.div>
                ...
                >
                  <span className="font-serif text-white text-2xl md:text-2xl lg:text-3xl font-bold leading-tight">
                    Beyond The Tools
                  </span>
                  <br />
              ...
              <div className="grid lg:grid-cols-3 gap-6 mt-14">
                {[
                  ...
                  >
                    <div className="w-14 h-14 rounded-2xl bg-[#FFEAEA] flex items-center justify-center text-[#FF1717]">
                      {card.icon}
                    </div>
                    <span className="mt-6 text-[#D52B2B] text-2xl font-bold">
                      {card.title}
                    </span>
                    <br />
